...
class AsioCallback : public ros::CallbackInterface,
                     public boost::enable_shared_from_this<AsioCallback> {
   public:
    AsioCallback(boost::asio::io_service& asio_queue, ros::CallbackQueue* ros_queue)
...
static inline void bindAsioToRos(boost::asio::io_service& asio_queue,
                                 ros::CallbackQueue* ros_queue = ros::getGlobalCallbackQueue()) {
